"""
Persona for a single person with 2 children receiving basic subsistence benefits.
...
@persona_description(
    description=(
        ...
        Single parent with two children aged 3 and 5.
...
def wohnen__bruttokaltmiete_m_hh() -> np.ndarray:
    return np.array([700, 700, 700])


@persona_input_element(start_date="2005-01-01")
def wohnen__heizkosten_m_hh() -> np.ndarray:
    return np.array([60, 60, 60])
