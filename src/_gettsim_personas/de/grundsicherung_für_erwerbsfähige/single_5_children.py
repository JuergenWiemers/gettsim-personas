"""
Persona for a single person with 5 children receiving basic subsistence benefits.
...
@persona_description(
    description=(
        ...
        Single parent with five children aged 3, 5, 7, 9, and 11.
...
def einkommensteuer__abzüge__kinderbetreuungskosten_m() -> np.ndarray:
    return np.array([0, 100, 100, 0, 0, 0])
