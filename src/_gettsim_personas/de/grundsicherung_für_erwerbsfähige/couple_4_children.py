"""
Persona for a couple with 4 children receiving basic subsistence benefits.
...
@persona_description(
    description=(
        ...
        Jointly taxed married couple with four children aged 3, 5, 7, and 9.
