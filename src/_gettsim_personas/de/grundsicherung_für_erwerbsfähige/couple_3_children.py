"""
Persona for a couple with 3 children receiving basic subsistence benefits.
...
@persona_description(
    description=(
        ...
        Jointly taxed married couple with three children aged 3, 5, and 7.
