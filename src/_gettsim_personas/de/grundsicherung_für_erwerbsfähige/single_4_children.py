"""
Persona for a single person with 4 children receiving basic subsistence benefits.
...
@persona_description(
    description=(
        ...
        Single parent with four children aged 3, 5, 7, and 9.
